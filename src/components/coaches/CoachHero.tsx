    ...
    <section className="relative min-h-[100dvh] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0">
        <video
          ...
          playsInline
          preload="auto"
          className="absolute inset-0 w-full h-full object-cover object-bottom opacity-[0.8]"
        >
      ...
      {/* Center: Content */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 lg:px-8 pt-16 md:pt-20 pb-20 md:pb-0">
        {/* Bold Statement */}
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="max-w-2xl text-sm md:text-base text-text-secondary mb-7 md:mb-5 text-center"
        >
          You know who&apos;s struggling physically. Do you know who&apos;s
          struggling mentally?
        </motion.p>
        ...
        >
          Build a Mentally{" "}
          <span className="gradient-text">Tougher Roster.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="mx-auto max-w-md md:max-w-xl text-[14px] md:text-base lg:text-lg text-text-secondary leading-relaxed mb-8 md:mb-8 text-center"
        >
      ...
      <motion.div
        ...
        className="relative z-10 pb-25 md:pb-16"
      >
        <p className="text-center text-xs md:text-sm text-text-muted px-6">
          Coach every athlete to their individual mental strengths and gaps.
        </p>
      </motion.div>
    </section>
  );
